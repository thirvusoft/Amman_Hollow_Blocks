...
def get_context(context):
	if frappe.session.user == "Guest":
		...
		frappe.db.get_value("User", frappe.session.user, "user_type", order_by=None) == "Website User" or frappe.db.get_value("User", frappe.session.user, "is_mobile_app_user")  # thirvusoft changes
	):
